...
-- vim.api.nvim_set_keymap("i", "<Esc>", "%s/stringOne/stringTwo/g | update | bd", { noremap = true, silent = true, desc = "Find and replace"})
...
-- Hack for treesitter I REALLY need to rewrite this config
